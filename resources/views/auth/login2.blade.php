                    ...
                    <div class="col-md-8">
                        <div class="under-construction-inner-content">
                            <div class="axil-title">
                                <h1 class="h1 m-0">Login</h1>
                            </div>
                            <div class="newsletter-content">
                                <div class="subscription-form-wrapper">
                                    <form method="POST" action="{{ route('admin.login') }}" class="subscription-form no-gutters">
                                    	@csrf
                                    ...
                                    <form action="#" class="subscription-form no-gutters">
                                        <div class="form-group">
                                            <button style="margin-left: 0;" class="btn btn-default btn-block google">LOGIN WITH GOOGLE</button>
                                        </div>
                                        <div class="form-group">
                                            <button style="margin-left: 0;" class="btn btn-default btn-block facebook">LOGIN WITH FACEBOOK</button>
                                        </div>
                                    </form>
